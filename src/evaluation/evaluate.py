...
from common.config import QRELS_PATH, RUNS_DIR
...
def main():
    ...
    ap.add_argument("--qrels", type=Path, default=QRELS_PATH,
                    help=f"Caminho para o arquivo qrels.tsv (default: {QRELS_PATH})")
    ap.add_argument("--runs", type=Path, nargs="+",
                    help=f"Caminhos para os arquivos de run.trec (default: todos os .trec em {RUNS_DIR})")
